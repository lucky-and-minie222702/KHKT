...
class CtrModel(nn.Module):
    def __init__(self):
        ...
        self.proj = nn.Sequential(
            nn.Linear(3584, 2432, dtype = torch.bfloat16),
            nn.BatchNorm1d(2432),
            nn.SiLU(),
            nn.Linear(2432, 1280, dtype = torch.bfloat16),
        )
...
if __name__ == "__main__":
    ...
    train_step = (50_000 // (batch_size * accum_step)) * epoch
    ...
    for step, batch in enumerate(pbar, 1):
        ...
        if step % accum_step == 0:
            ...
            torch.save(model.encoder.state_dict(), "pretrained_vision.torch")
